...
<html>
<head>
<title>Labyrinth Lord Illusionist Character Generator</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Labyrinth Lord Illusionist Character Generator. Goblinoid Games.">
	<meta name="keywords" content="Labyrinth Lord, Goblinoid Games,HTML5,CSS,JavaScript">
	<meta name="author" content="Mark Tasaka 2018">
		

	<link rel="stylesheet" type="text/css" href="css/ll_illusionist.css">
	<link rel="stylesheet" type="text/css" href="css/ll_illusionist_post.css">
...
<body>
    ...
    include 'php/illusionistSpells.php';
    ...
    $spellsLevel5 = level5Spells ($level);
    $spellsLevel6 = level6Spells ($level);
    $spellsLevel7 = level7Spells ($level);
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
       ...
       <span id="class">Illusionist</span>
	...
	*/
	function Character() {
		...
		let illusionistCharacter = {
            ...
            "spellProbability": spellProbability (intelligence),
	    ...
	    if(illusionistCharacter.hitPoints <= 0 ){
			illusionistCharacter.hitPoints = 1;
		}
		return illusionistCharacter;
       ...
       let imgData = "images/illusionist_character_sheet.png";
      ...
      $("#spellProb").html(data.spellProbability);
