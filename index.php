...
<html>
<head>
<title>Launch Page: Labyrinth Lord Illusionist Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="illusionistForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Illusionist</option>
				<option value="2">2nd Level, Illusionist</option>
				<option value="3">3rd Level, Illusionist</option>
				<option value="4">4th Level, Illusionist</option>
				<option value="5">5th Level, Illusionist</option>
				<option value="6">6th Level, Illusionist</option>
				<option value="7">7th Level, Illusionist</option>
				<option value="8">8th Level, Illusionist</option>
				<option value="9">9th Level, Illusionist</option>
				<option value="10">10th Level, Illusionist</option>
				<option value="11">11th Level, Illusionist</option>
				<option value="12">12th Level, Illusionist</option>
				<option value="13">13th Level, Illusionist</option>
				<option value="14">14th Level, Illusionist</option>
				<option value="15">15th Level, Illusionist</option>
			  </select>
			...
			<!--	<option value="Dwarf">Dwarf (9)*</option>
				<option value="Elf">Elf (10)*</option>-->
				<option value="Gnome">Gnome (7)*</option>
				<!--<option value="Halfling">Halfling (6)*</option>
				<option value="Half-Elf">Half-Elf (12)*</option>
				<option value="Half-Orc">Half-Orc (12)*</option>-->
			  </select>
                
               <p><span class="footnote2">&#42;Maximum demi-human illusionist level.</span></p>
            ...
            <div id="weaponsGroupings">
              <!--  <input type="checkbox" name="theWeapons[]" value="0"> Axe, battle+<br/>
               ...
               <!-- <input type="checkbox" name="theWeapons[]" value="9"> Darts x 2<br/> 
                ...
                <input type="checkbox" name="theWeapons[]" value="35"> Dagger, silver x 2<br/> 
                <input type="checkbox" name="theWeapons[]" value="36"> Dagger, silver x 3<br/> 
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#illusionistForm").attr('action', "character/ll_illusionist_"+ $("#abilityScores").val() +  ".php");
